...
variable "secret_kms_key_id" {
  type        = string
  default     = null
  description = "KMS key ID or ARN used to encrypt the Aurora master secret in Secrets Manager. If not set, AWS encrypts it with the default aws/secretsmanager managed key."
}
